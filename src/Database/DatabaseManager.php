...
class DatabaseManager implements ConnectionResolverInterface
{
    ...
    public function connection($name = null)
    {
        ...
        // var_dump($this->connections[$name]::class);
     ...
     * @return void
     */
    protected function registerConfiguredDoctrineTypes($connection): void
    {
    ...
    private function isPoolConnection($name)
    {
        return $this->app['config']['database']['connections'][$name]['driver'] === 'mysql-pool';
    }
}
